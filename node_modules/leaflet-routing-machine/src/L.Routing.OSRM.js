(function() {
	...
	L.Routing.OSRM = L.Class.extend({
        ...
        _handleRoute: function(response, route_index, inputWaypoints) {
            ...
            console.log(response.routes[route_index]);
        ...
        _legacyTranslateInstruction: function( instruction, index, all, passed_intersections ){
          ...
          if( instruction.type === "enter roundabout" ||
              instruction.type === "leave roundabout" ||
              instruction.type === "enter traffic circle" ||
              instruction.type === "leave traffic circle" ){
            return "Roundabout";
          }
        ...
        _handleInstruction: function(step, running_index, step_index, of_steps, passed_intersections) {
            return {
                ...
                time : step.duration,
                road : step.name,
                direction: step.heading_after,
                exit: step.exit !== 0 ? step.exit : undefined,
                index : running_index
            };
        },
