...
describe("applyReplacements — leaflet_options.js content", () => {
  ...
  test("does not attempt to replace a mapbox token", () => {
    ...
    const result = applyReplacements(contentWithPlaceholder, {
      OSRM_MAPBOX_TOKEN: "new-token",
    });
